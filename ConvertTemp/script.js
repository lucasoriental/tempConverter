        ...
        function CelToFah(){
            ...
            celsiusNum1 = Number(Celsius1.value)
                if(celsiusNum1 == ''){
        ...
        function CelToKel(){
            ...
            celsiusNum2 = Number(Celsius2.value)
                if(celsiusNum2 == ''){
                    alert('Something is wrong... Please insert a number')
                } else{
    ...
    // FAHRENHEIT
        ...
        FahToCel = () => {
            ...
            fahrenheitNum1 = Number(fahrenheit1.value)
            if(fahrenheitNum1 == ''){
                alert('Something is wrong... Please insert a number')
            } else{
        ...
        FahToKel = () => {
            ...
            fahrenheitNum2 = Number(fahrenheit2.value)
            if(fahrenheitNum2 == ''){
                alert('Something is wrong... Please insert a number')
            } else {
    ...
    // KELVIN
        ...
        KelToCel = () => {
            ...
            KelvinNum1 = Number(kelvin1.value)
            if(KelvinNum1 == ''){
                alert('Something is wrong... Please insert a number')
            } else {
        ...
        KelToFah = () => {
            ...
            KelvinNum2 = Number(kelvin2.value)
            if (KelvinNum2 == ''){
                alert('Something is wrong... Please insert a number')
            } else {
